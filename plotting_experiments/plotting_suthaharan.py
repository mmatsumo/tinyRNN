...
plot_perf_exp_folders += ['exp_Suthaharan_sub_avg'] if 'plot_perf_for_all_subs' in plotting_pipeline else []
    ...
    for add_text in [True, False]:
        for load_file_suffix, figname in [
            ...
            plot_all_model_losses(exp_folder,
                          ...
                          rnn_filters={'readout_FC': True}, # filters at the plot level
                          xlim=[0.91, 22],
...
if 'plot_dim_for_all_exps' in plotting_pipeline:
    plot_dim_distribution('exp_Suthaharan_sub_avg', suffix='_noMLR',
                          bins=[1, 2, 3, 4, 5, 6, 7],
...
if 'plot_dynamical_regression_distribution' in plotting_pipeline:
    for cog_type, percent in [
        ...
        plt_dynamical_regression_violin_suthaharan('exp_Suthaharan', model_filters={'cog_type': cog_type}, percent=percent)
