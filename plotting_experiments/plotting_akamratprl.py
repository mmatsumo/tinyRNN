...
model_curve_setting = { # for monkey, all MBs are MFs
    ...
    'MB0': ModelCurve('MB', 'MF', MF_color,dot_alpha, 'o', markersize, 1, '-'),
    'MB1': ModelCurve('MB_decay', 'MF', MF_color, dot_alpha, 'o', markersize, 1, '-'),
...
for exp_folder in plot_perf_exp_folders:
    ...
    for add_text in [True, False]:
        for perf_type, figname, ylim, yticks in [#('test_loss','loss_all_models',[0.37, 0.51],[0.4, 0.45, 0.5]),
