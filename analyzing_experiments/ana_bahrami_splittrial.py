...
compile_folder = 'exp_Bahrami_splittrial_sub_avg'
additional_rnn_keys={'model_identifier_keys': ['distill',]} # the augment in the results is none, but is augment=2 during training
# perf
