"""
Run all models on Suthaharan Human, three-armed bandit. The train-val split is on trials, not subjects.
"""
import sys
sys.path.append('..')
...
dt_aug = Dataset('SuthaharanHuman', behav_data_spec={'augment': 2}, verbose=False)
train_trial_index, val_trial_index, test_trial_index = split_over_trials(160, n_trial_splits=[120,20,20], seed=0)
...
if run_student_rnn:
      ...
      teacher_test_indexes, teacher_model_path = load_teacher_summary('exp_Suthaharan_splittrial', selector={'hidden_dim': 50, 'distill': 'none','blockinfo': 'none'})
