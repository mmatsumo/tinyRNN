...
config_ranges = { # keys are used to generate model names
      'agent_name': [#'GRU_1_seed0', 'GRU_2_seed0', 'MXs_seed0',
            'SGRU_1_seed0',
            # 'MB0s_seed0',
            #'LS0_seed0',
            # 'LS1_seed0', 'MB0_seed0', 'MB1_seed0', 'MB0md_seed0',
                     #'Q(0)_seed0',
                     #'Q(1)_seed0'
                     ],
      'rnn_type': ['GRU'],
...
config_ranges = {  # keys are also used to generate model names
      'agent_name': ['SGRU_1_seed0',
            #'GRU_1_seed0', 'GRU_2_seed0', 'MXs_seed0',
                     # 'MB0s_seed0', 'LS0_seed0', 'LS1_seed0', 'MB0_seed0', 'MB1_seed0', 'MB0md_seed0', 'RC_seed0', 'Q(0)_seed0', 'Q(1)_seed0'
                     ],
      'cog_type': [#'BAS',
