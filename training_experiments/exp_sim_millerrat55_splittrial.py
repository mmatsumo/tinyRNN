"""
Run all models on Miller's rat 55 simulated agents. The train-val split is on trials, not subjects.
"""
import sys
sys.path.append('')
...
dt = Dataset('SimAgent',
             behav_data_spec={'agent_path': ['RTS_agents_millerrat55'], 'agent_name': 'LS0_seed0'},
             verbose=False)
train_trial_index, val_trial_index, test_trial_index = split_over_trials(100, n_trial_splits=[70,15,15], seed=0)
base_config = {
      ### dataset info
      'dataset': 'SimAgent',
      'behav_format': 'tensor',
      ...
      'split_training': True,
      'train_index': np.arange(0, dt.batch_size),
...
config_ranges = { # keys are used to generate model names
      'agent_name': [#'GRU_1_seed0', 'GRU_2_seed0',
            'MXs_seed0',
            # 'SGRU_1_seed0',
            'MB0s_seed0',
            'LS0_seed0',
...
agent_name = 'MXs_seed0' #'LS0_seed0' #'MB0s_seed0' #,'MB0_seed0','MB1_seed0','MXs_seed0',
config_ranges = {  # keys are also used to generate model names
      'agent_name': [#'SGRU_1_seed0',
            #'GRU_1_seed0', 'GRU_2_seed0', 'MXs_seed0',
                     # 'MB0s_seed0', #'LS0_seed0', 'LS1_seed0',
            #'MB0_seed0',#
             #'MB1_seed0', #'MB0md_seed0', 'RC_seed0', 'Q(0)_seed0', 'Q(1)_seed0'
            agent_name
                     ],
      'cog_type': [#'BAS',
                    #'RC',
