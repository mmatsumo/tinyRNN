"""
Run simulations of the agents, with parameters fit to all Miller Rats data.
"""
import sys
sys.path.append('..')
...
for sub in [#55, 64, 70,
            71]:
    ana_exp_path = ANA_SAVE_PATH / f'exp_seg_millerrat{sub}'
    ...
    for n_blocks, n_trials in [
        ...
        for model_type in [   'MB0s', 'LS0', 'LS1', 'MB0', 'MB1', #'MB0md',
                              'RC', 'Q(0)', 'Q(1)',
                    'MXs'
                ]:
