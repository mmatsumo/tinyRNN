...
This file overlaps with allagents_millerrat55.
This file is mainly for generating the behavioral data that are directly fitted to different models.
100 blocks and 100 trials are usually enough.
Keep this file for compatibility for existing code.
"""
import sys
sys.path.append('..')
...
for n_blocks in [
      ...
      if n_blocks != sim_config['n_blocks']:
      ...
      iter_model_infos.append(
            ('SGRU', '1', rnn_summary[(rnn_summary['rnn_type'] == 'SGRU') & (rnn_summary['hidden_dim'] == 1) & (rnn_summary['readout_FC'])], summary_cond))
      # iter_model_infos.append(
      #       ('GRU', '2', rnn_summary[(rnn_summary['rnn_type'] == 'GRU') & (rnn_summary['hidden_dim'] == 2) & (rnn_summary['readout_FC'])], summary_cond))
